...
const ArtistCard: React.FC<ArtistCardProps> = ({ artist, onClick, theme = 'dark' }) => {
  ...
  const bgHover = isDark ? '#001f3f' : '#f8fafc'; // Anjakan halus ke arah biru gelap atau kelabu cerah
      ...
      <div className="absolute inset-0 p-8 md:p-10 flex flex-col justify-between pointer-events-none">
        <div className="flex justify-between items-start">
           ...
           <motion.div
             ...
             className="bg-[#EE2A24] text-white rounded-full p-3 shadow-lg"
           >
        ...
        <div>
          <div className="overflow-hidden mb-2">
            <motion.h3 
              className={`font-heading text-3xl md:text-4xl font-black uppercase leading-tight will-change-transform`}
          ...
          >
            <div className="w-10 h-px bg-[#EE2A24]" />
            <p className="text-xs md:text-sm font-bold uppercase tracking-[0.25em] text-[#EE2A24]">
              {artist.genre}
            </p>
          </motion.div>
        </div>
